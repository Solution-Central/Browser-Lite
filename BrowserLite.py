...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Next Button
        nextBtn = QAction(QIcon('Forward.png'), 'Next', self)
        ...
        self.http.setPixmap(QPixmap('Http.png').scaled(30,30))
        ...
        # Stop Button
        stopBtn = QAction(QIcon('Stop.png'), 'Stop', self)
...
##        print('Exit')
    ...
    def updateUrl(self, q):
        ...
        if q.scheme() == 'https':
            # Secure
            self.http.setPixmap(QPixmap('Https.png').scaled(25,25))
        else:
            # Insecure
            self.http.setPixmap(QPixmap('Http.png').scaled(30,30))
